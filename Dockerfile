...
LABEL maintainer="Network Concern <synology@networkconcern.com>"
...
# Create unifi user/group and install the UniFi controller package
RUN set -ex \
...
# Start the UniFi controller using the entrypoint script
